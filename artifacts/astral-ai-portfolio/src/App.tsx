...
function Hero() {
  ...
  <span>{typedRole}</span><span className="role-terminal-caret" aria-hidden="true" />
          ...
          <Reveal delay={.08}>
            <h1 id="hero-heading" className="display-title mt-7 max-w-[720px] text-[clamp(3.7rem,9vw,7.9rem)]">I build intelligence that stays <span className="block sm:inline-block whitespace-nowrap gold-text">
